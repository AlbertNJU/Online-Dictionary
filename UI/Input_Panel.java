		...
		public void mouseClicked(MouseEvent e) {
			...
			if(Data.MainData.isLogin){
				...
				Data.MainData.friendList.setSelectedIndex(0);
				 ...
				 JOptionPane.showMessageDialog(null, "尚未登录，无法进入好友系统", "Error", JOptionPane.ERROR_MESSAGE);
			}
		}
	...
	class emailMouseListener implements MouseListener{
		...
		public void mouseClicked(MouseEvent e) {
			...
			if(Data.MainData.isLogin){
				 ...
				 JOptionPane.showMessageDialog(null, "尚未登录，无法进入收件箱", "Error", JOptionPane.ERROR_MESSAGE);
			}
		}
	 ...
	 class ButtonClickListener implements ActionListener{
		 public void actionPerformed(ActionEvent ev){
			 if(Data.MainData.InputText.getText() != null){	
				 ...
				 if(numOfLetter == 0){
					 JOptionPane.showMessageDialog(null, "您查询的单词或词组不存在，请输入正确的英文单词或词组", "Error", JOptionPane.ERROR_MESSAGE);
				 }
