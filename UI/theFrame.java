...
public class theFrame extends JFrame{
	...
	public theFrame(){
		...
		//Data.MainData.frame.setBackground(Color.getHSBColor(h, s, b)));
	/*	JMenuBar menuBar= new JMenuBar();
		JMenu fileMenuWord = new JMenu("Words");
		JMenu fileMenuSentence = new JMenu("Sentences");
		menuBar.add(fileMenuWord);
		menuBar.add(fileMenuSentence);
		Data.MainData.frame.setJMenuBar(menuBar);*/
	...
	public static BufferedImage getWordCard() throws Exception{
		robot = new Robot();
